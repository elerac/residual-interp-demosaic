...
try:
    from demosaic_reference.matlab_compat import boxfilter as _shared_boxfilter
    from demosaic_reference.matlab_compat import imfilter as _shared_imfilter
except Exception:  # pragma: no cover - used only while shared primitives are absent.
    _shared_boxfilter = None
    _shared_imfilter = None

try:
    from demosaic_reference.bayer import mask_gr_gb as _shared_mask_gr_gb
except Exception:  # pragma: no cover - used only while shared primitives are absent.
